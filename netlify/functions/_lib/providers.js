// OAuth provider configs. Each provider needs a client id/secret set as
// env vars (see README's "Accounts" section for exact registration steps).

function redirectUri(event, provider) {
