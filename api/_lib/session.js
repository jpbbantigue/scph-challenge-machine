// Minimal HMAC-signed session token — same scheme as the Netlify version
// (netlify/functions/_lib/session.js), ported for Vercel's (req, res) style.
...
// req: a Node/Vercel request object with a `headers` object
